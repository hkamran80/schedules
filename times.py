times = {
    "ca-auhsd-ahs": {
        "MON": {
            ...
            "Passing: 1/2": ("9-20-01", "9-25-00"),
            "2nd Period": ("9-25-01", "10-10-00"),
        ...
        "TUE": {
            ...
            "Passing: 1/2": ("9-30-01", "9-40-00"),
            "2nd Period": ("9-40-01", "11-10-00"),
    ...
    "ca-auhsd-dls": {
        "MON": {
            "Zero Period": ("7-45-00", "8-50-00"),
            "Virtual Cohort Academy": ("9-00-00", "9-45-00"),
            "Passing (Virtual Cohort Academy / First Period)": ("9-45-01", "9-59-59"),
        ...
        "TUE": {
            "First Period": ("9-00-00", "10-15-00"),
            "Passing (First / Second Periods)": ("10-15-01", "10-29-59"),
            "Second Period": ("10-30-00", "11-45-00"),
            "Lunch": ("11-45-01", "12-29-59"),
            "Third Period": ("12-30-00", "13-45-00"),
            "Passing (Third / Seventh Periods)": ("13-45-01", "13-59-59"),
            "Seventh Period": ("14-00-00", "15-15-00")
        },
        "WED": {
            "Virtual Academy": ("9-00-00", "9-45-00"),
            "Passing (Virtual Academy / Fourth Period)": ("9-45-01", "9-59-59"),
            "Fourth Period": ("10-00-00", "11-15-00"),
            "Passing (Fourth / Fifth Periods)": ("11-15-01", "11-29-59"),
            "Fifth Period": ("11-30-00", "12-45-00"),
            "Lunch": ("12-45-01", "13-29-59"),
            "Sixth Period": ("13-30-00", "14-45-00"),
            "Passing (Sixth / Zero Periods)": ("14-45-01", "14-54-59"),
            "Zero Period": ("14-55-00", "16-00-00")
        },
        "THU": {
            "First Period": ("9-00-00", "10-15-00"),
            "Passing (First / Second Periods)": ("10-15-01", "10-29-59"),
