...
def schedule(schedule_id):
	if request.method == "GET":
        ...
        return render_template("index.html", schedule_valid=True, schedule_id=schedule_id, schedule_name=schedule_name, schedule_color=schedule_id, raw_schedule_json=json.dumps(period_calculator.times), schedule_id=schedule_id)
